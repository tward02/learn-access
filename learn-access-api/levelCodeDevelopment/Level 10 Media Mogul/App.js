    ...
    return (
        <div>
            <video className="videoPlayer" data-testid="video" controls aria-describedby="video-description">
                <source data-testid="source" src="https://videos.pexels.com/video-files/4872339/4872339-hd_1920_1080_30fps.mp4" type="video/mp4" />
            ...
            <div className="transcript">
                ...
                <p>[Narrator] Here are some ducks. They appear to be looking for food and eating. [Ducks] Quack Quack Quack.</p>
            </div>
        </div>
    );
};
